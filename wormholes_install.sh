#!/bin/bash
#check docker cmd
echo "Script version Number: v0.12.0"
...
#vt5=$(cat vt5_version | awk '{print $1}')
vt5=$(wget https://docker.wormholes.com/vt5_version>/dev/null 2>&1 && cat vt5_version | awk '{print $1}')
